...
namespace AzStorage.Utilities
{
    public class BlobReset
    {
        ...
        public BlobReset(string connectionString)
        {
        ...
        private CloudStorageAccount CreateStorageAccountFromConnectionString(string storageConnectionString)
        {
            ...
            {
                throw new FormatException("Invalid storage account information provided. Please confirm the AccountName and AccountKey are valid in the app.config file - then restart the sample.");
            }
